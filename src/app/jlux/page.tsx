    ...
    <div className="bg-[#f6f7f0] min-h-screen">
      ...
      <div ref={heroRef} className="relative w-screen overflow-hidden">
        ...
        >
          <motion.div className="absolute inset-0" style={{ y }}>
            <img
              loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/about-us.webp"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden aspect-[4/5]">
                <img
                  loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/student-clubs.webp"
                  alt="JLUx Students"
      ...
      <section className="relative py-20 md:py-32 px-4 sm:px-6 md:px-16 overflow-hidden">
        <div className="absolute inset-0">
          <img
            loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/admissions.webp"
            alt="JLUx Mentorship"
            className="w-full h-full object-cover"
          />
      ...
      <section className="bg-[#f6f7f0] py-16 md:py-24 px-4 sm:px-6 md:px-16">
        <div className="mx-auto max-w-[1200px]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <img
                loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/hero.webp"
