...
export const metadata: Metadata = {
  ...
  keywords: ['JLU architecture', 'B.Arch Bhopal', 'architecture college', 'COA approved', 'Jagran School of Architecture'],
};
...
const architectureData = {
  ...
  features: [
    ...
    'Part of a broader design ecosystem alongside Jagran School of Design',
  ],
