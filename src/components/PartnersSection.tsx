        ...
        <div className="px-3">
          ...
          <div>
            ...
            <div className="flex">
              ...
              >
                <img loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/mid.webp" alt="Middlesex University" style={{ maxHeight: '40px' }} className="object-contain" />
              </div>
              <div
                className="border border-l-0 border-gray-300 flex items-center justify-center"
                style={{ width: 'calc(50vw - 6px)', height: '80px' }}
              >
                <img loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/king.webp" alt="King's College London" style={{ maxHeight: '40px' }} className="object-contain" />
              </div>
            </div>
          </div>
          ...
          <div className="mt-3">
            ...
            <div className="flex">
              ...
              >
                <img loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/nus.webp" alt="NUS" style={{ maxHeight: '50px' }} className="object-contain" />
              </div>
              <div
                className="border border-l-0 border-gray-300 flex items-center justify-center"
                style={{ width: 'calc(33.33vw - 4px)', height: '70px' }}
              >
                <img loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/c11.webp" alt="CII" style={{ maxHeight: '32px' }} className="object-contain" />
              </div>
              <div
                className="border border-l-0 border-gray-300 flex items-center justify-center"
                style={{ width: 'calc(33.33vw - 4px)', height: '70px' }}
              >
                <img loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/ficci.webp" alt="FICCI" style={{ maxHeight: '32px' }} className="object-contain" />
              </div>
            </div>
            ...
            <div className="flex">
              <div
                ...
                style={{ width: 'calc(33.33vw - 4px)', height: '70px' }}
              >
                <img loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/gt.webp" alt="Grant Thornton" style={{ maxHeight: '26px' }} className="object-contain" />
              </div>
              <div
              ...
              <div
                ...
                style={{ width: 'calc(33.33vw - 4px)', height: '70px' }}
              >
                <img loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/era.webp" alt="ERA" className="object-cover w-full h-full" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="px-4 lg:px-16 xl:px-20 2xl:px-32">
          ...
          <div>
            ...
            <div className="flex">
              ...
              >
                <img
                  loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/mid.webp"
              ...
              >
                <img
                  loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/king.webp"
          ...
          <div className="mt-6">
            ...
            <div className="flex">
              ...
              >
                <img
                  loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/nus.webp"
                  alt="NUS"
              ...
              >
                <img
                  loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/c11.webp"
                  alt="CII"
              ...
              >
                <img
                  loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/ficci.webp"
                  alt="FICCI"
                  className="max-h-24 object-contain"
                />
              </div>
            ...
            <div className="flex">
              ...
              >
                <img
                  loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/gt.webp"
                  alt="Grant Thornton"
              ...
              >
                <img
                  loading="lazy" decoding="async" src="https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/era.webp"
                  alt="ERA"
