...
export const SchoolPage = ({ school, faculty }: SchoolPageProps) => {
  ...
  const parallaxY = useTransform(parallaxProgress, [0, 1], ['-8%', '0%']);
    ...
    <div className="bg-[#f6f7f0] min-h-screen overflow-x-hidden">
      ...
      <section className="w-full m-0 p-0 overflow-x-hidden">
        <div ref={heroRef} className="relative w-full m-0 p-0 overflow-hidden">
          <motion.div
            className="relative w-full min-h-svh md:min-h-screen"
          ...
          {/* Large gradient text */}
          <div className="absolute bottom-0 left-0 pl-4 sm:pl-6 md:pl-10 pb-0">
            <motion.h1
          ...
          <motion.div
            ...
            className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 md:bottom-10 md:right-10 flex items-center gap-2 sm:gap-3 bg-black/40 border border-white/15 rounded-full px-3 py-2 sm:px-5 sm:py-3"
          >
            <span className="text-[#f0c14b] text-base sm:text-xl md:text-2xl font-bold">{school.programs.length}</span>
            <span className="text-white/80 text-[10px] sm:text-xs uppercase tracking-wider">Programs</span>
          </motion.div>
        </div>
      </section>
      ...
      {/* ============================================ */}
      <section ref={aboutRef} className="relative py-12 sm:py-20 md:py-0 bg-white overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-0 md:min-h-[80vh] items-center">
            ...
            <div className="md:col-span-6 relative z-10 md:-ml-16 py-6 sm:py-10 md:py-20 px-2 sm:px-6 md:px-0 overflow-hidden">
              <motion.div
                initial={{ x: '100%' }}
                animate={aboutInView ? { x: 0 } : { x: '100%' }}
                transition={{ duration: 1.2, delay: 0.3, ease: customEase }}
              >
              <div className="md:bg-white md:rounded-3xl p-4 sm:p-6 md:p-12 md:shadow-2xl md:shadow-black/5">
                <span className="text-[#f0c14b] text-[10px] md:text-xs tracking-[0.3em] uppercase block mb-3 sm:mb-4 font-medium">
                  About the School
                </span>
                <h2
                  className="text-[#21313c] text-2xl sm:text-3xl md:text-4xl lg:text-[3.2rem] font-semibold mb-4 sm:mb-6"
                ...
                <p className="text-[#666] text-sm md:text-[15px] mb-6 sm:mb-8" style={{ lineHeight: 1.9 }}>
                  {school.description}
                </p>
                ...
                <div className="flex flex-wrap gap-4 sm:gap-6 mb-6 sm:mb-8">
                  {faculty.stats.slice(0, 3).map((stat, i) => (
                    <div key={i} className="text-center">
                      <span className="text-[#21313c] text-xl sm:text-2xl md:text-3xl font-bold block" style={{ letterSpacing: '-0.02em' }}>
                        {stat.value}
                      </span>
      ...
      {/* ============================================ */}
      <section className="py-14 sm:py-20 md:py-32 bg-[#21313c] relative overflow-hidden">
        {/* Background decorative elements */}
        <div className="absolute top-0 right-0 w-75 sm:w-125 h-75 sm:h-125 rounded-full" style={{ background: 'radial-gradient(circle, rgba(240,193,75,0.05) 0%, transparent 70%)' }} />
        <div className="absolute bottom-0 left-0 w-62.5 sm:w-100 h-62.5 sm:h-100 rounded-full" style={{ background: 'radial-gradient(circle, rgba(195,253,122,0.05) 0%, transparent 70%)' }} />
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-12 relative z-10">
          ...
          >
            <div>
              ...
              <h2
                className="text-white text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-semibold"
                style={{ letterSpacing: '-0.03em', lineHeight: 1.05 }}
              >
                Programs{' '}
            ...
            <p className="text-white/40 text-xs sm:text-sm mt-3 md:mt-0 max-w-87.5" style={{ lineHeight: 1.7 }}>
          ...
          <div className="space-y-2 sm:space-y-3">
            {school.programs.map((program, i) => (
              <motion.div
                ...
                className="group flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-6 py-4 sm:py-6 border-b border-white/10 hover:border-[#f0c14b]/40 transition-colors cursor-default"
              >
                <div className="flex items-start sm:items-center gap-3 sm:gap-6">
                  <span className="text-white/20 font-mono text-xs sm:text-sm w-6 sm:w-8 shrink-0 mt-1 sm:mt-0">
                    {String(i + 1).padStart(2, '0')}
                  </span>
                  <h3 className="text-white text-base sm:text-xl md:text-2xl font-semibold group-hover:text-[#f0c14b] transition-colors" style={{ letterSpacing: '-0.01em' }}>
                    {program.name}
                  </h3>
                </div>
                <div className="flex items-center gap-2 sm:gap-3 ml-9 sm:ml-0">
                  <span className="text-white/30 text-[10px] sm:text-xs bg-white/5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full border border-white/10">
                    {program.duration}
                  </span>
      ...
      {/* ============================================ */}
      <section className="py-14 sm:py-20 md:py-32 bg-[#f6f7f0]">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-12">
          ...
          >
            ...
            <h2
              className="text-[#21313c] text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-semibold"
              style={{ letterSpacing: '-0.03em', lineHeight: 1.05 }}
            >
              What Makes Us{' '}
              <span style={{ fontFamily: "'Times New Roman', serif", fontStyle: 'italic', fontWeight: 400 }}>
            ...
            {school.highlights.map((highlight, i) => {
              ...
              if (i === 0) {
                return (
                  ...
                  >
                    ...
                    />
                    <div className="absolute inset-0 bg-linear-to-t sm:bg-linear-to-r from-[#21313c]/95 via-[#21313c]/70 to-transparent" />
                    <div className="relative z-10 flex flex-col justify-end sm:justify-center h-full p-6 sm:p-8 md:p-14 max-w-150">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#f0c14b] flex items-center justify-center mb-4 sm:mb-6">
                      ...
                      <p className="text-white text-base sm:text-lg md:text-2xl font-semibold mb-2 sm:mb-3" style={{ lineHeight: 1.3 }}>
                        {highlight}
                      </p>
                      <span className="text-white/40 text-[10px] sm:text-xs uppercase tracking-wider">Top Highlight</span>
                    </div>
                  </motion.div>
                );
              }
              ...
              return (
                <motion.div
                  ...
                  className="bg-white rounded-2xl p-5 sm:p-7 md:p-8 hover:shadow-xl transition-all duration-300 group border border-transparent hover:border-[#f0c14b]/20"
                >
                  <div className="flex items-start gap-3 sm:gap-5">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#f6f7f0] group-hover:bg-[#f0c14b]/10 flex items-center justify-center shrink-0 transition-colors">
          ...
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12">
            ...
            >
              <div>
                ...
                <h2
                  className="text-[#21313c] text-2xl sm:text-3xl md:text-5xl font-semibold"
                  style={{ letterSpacing: '-0.03em', lineHeight: 1.05 }}
                >
                  Other Schools in{' '}
                  <span style={{ fontFamily: "'Times New Roman', serif", fontStyle: 'italic', fontWeight: 400 }}>
              ...
              <p className="text-[#666] text-xs sm:text-sm max-w-87.5 mt-3 md:mt-0" style={{ lineHeight: 1.7 }}>
      ...
      <section className="relative overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-[40vh] md:min-h-[50vh]">
          {/* Left — Image */}
          <div className="relative min-h-50 sm:min-h-75 md:min-h-0">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <motion.span
                ...
                style={{ fontFamily: 'system-ui', lineHeight: 1, letterSpacing: '-0.04em', fontSize: 'clamp(5rem, 12vw, 10rem)' }}
              >
                JLU
              </motion.span>
            </div>
          ...
          {/* Right — CTA content */}
          <div className="bg-[#f0c14b] flex items-center justify-center p-8 sm:p-10 md:p-16">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <h2
                className="text-[#21313c] text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-4 sm:mb-5"
                style={{ letterSpacing: '-0.03em', lineHeight: 1.05 }}
              >
                Ready to{' '}
                <span style={{ fontFamily: "'Times New Roman', serif", fontStyle: 'italic', fontWeight: 400 }}>
              ...
              <p className="text-[#21313c]/60 text-xs sm:text-sm mb-6 sm:mb-8" style={{ lineHeight: 1.8 }}>
