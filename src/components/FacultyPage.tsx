...
export const FacultyPage = ({ facultyId, heroImage, bigText }: FacultyPageProps) => {
  ...
  const resolvedHeroImage = heroImage ?? faculty.schools[0]?.image ?? 'https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/optimized/acedemics/acedemics%20landing%20page.webp';
