    ...
    <section className="w-screen m-0 p-0 overflow-x-hidden">
      ...
      <div ref={heroRef} className="relative w-screen m-0 p-0 overflow-hidden">
        ...
        >
          <motion.h1
            ...
            className="font-normal select-none text-[17vw] sm:text-[9rem] md:text-[clamp(8rem,14vw,14rem)] whitespace-nowrap"
            style={{
      ...
      <div id="student-clubs" className="w-full" style={{ backgroundColor: '#f6f7f0' }}>
        <div className="mx-auto px-5 sm:px-8 md:px-[120px] py-20 md:py-32" style={{ maxWidth: '1440px', ...(isMobile ? { paddingTop: '40px', paddingBottom: '40px' } : {}) }}>
          ...
          >
            ...
            <p className="text-[#666] text-base md:text-lg max-w-3xl mb-16" style={{ lineHeight: 1.8, ...(isMobile ? { fontSize: '13px', marginBottom: '20px' } : {}) }}>
                ...
                {studentClubs.map((club, i) => (
                  <motion.button
                    ...
                    style={{
                      ...
                      ...(isMobile ? { padding: '8px 12px', gap: '10px' } : {}),
                    }}
                  ...
                  >
                    ...
                    <span className="font-medium text-sm md:text-base" style={isMobile ? { fontSize: '12px' } : {}}>{club.name}</span>
                    {activeClubIndex === i && (
            ...
            <div className="lg:w-[55%] lg:sticky lg:top-32 lg:self-stretch">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="relative w-full flex-1 min-h-[220px] overflow-hidden" style={isMobile ? { minHeight: '160px' } : {}}>
                    <motion.div
                  ...
                  {/* Club Text */}
                  <div className="p-7 md:p-9" style={isMobile ? { padding: '16px' } : {}}>
                    <h3
                      className="text-[#21313c] text-2xl md:text-3xl font-semibold mb-4"
                      style={{ letterSpacing: '-0.02em', ...(isMobile ? { fontSize: '16px', marginBottom: '8px' } : {}) }}
                    >
                    ...
                    <div className="flex items-center gap-2 text-sm text-[#999]" style={isMobile ? { fontSize: '11px' } : {}}>
      ...
      <div id="cultural-activities" className="w-full bg-white">
        <div className="mx-auto px-5 sm:px-8 md:px-[120px] py-20 md:py-32" style={{ maxWidth: '1440px', ...(isMobile ? { paddingTop: '40px', paddingBottom: '40px' } : {}) }}>
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 mb-20" style={isMobile ? { gap: '20px', marginBottom: '30px' } : {}}>
            ...
            <div ref={achieveImgRef} className="lg:w-[45%] lg:sticky lg:top-32 lg:self-start">
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 p-6 md:p-8" style={isMobile ? { padding: '12px' } : {}}>
                  <p className="text-white/70 text-sm mb-1" style={isMobile ? { fontSize: '11px' } : {}}>
                    {expandedAchievement !== null ? achievements[expandedAchievement].category : 'JLU Achievements'}
                  </p>
                  <p className="text-white font-semibold text-lg md:text-xl" style={{ letterSpacing: '-0.02em', ...(isMobile ? { fontSize: '14px' } : {}) }}>
              ...
              <div className="grid grid-cols-3 gap-4 mt-6" style={isMobile ? { gap: '8px', marginTop: '12px' } : {}}>
                {[{ n: '6+', l: 'National Wins' }, { n: '3', l: 'International Awards' }, { n: '300+', l: 'Competitions' }].map((s, i) => (
                  <motion.div
                    ...
                    style={isMobile ? { padding: '8px 4px' } : {}}
            ...
            <div className="lg:w-[55%]">
              <p className="text-[#666] text-base md:text-lg mb-10" style={{ lineHeight: 1.8, ...(isMobile ? { fontSize: '13px', marginBottom: '16px' } : {}) }}>
                ...
                {achievements.map((achievement, i) => (
                  ...
                  >
                    <button
                      ...
                      style={isMobile ? { paddingTop: '12px', paddingBottom: '12px' } : {}}
                    >
                      <div className="flex items-center gap-3 md:gap-5 flex-1" style={isMobile ? { gap: '8px' } : {}}>
                        ...
                        <h3
                          ...
                          style={{ letterSpacing: '-0.02em', ...(isMobile ? { fontSize: '12px' } : {}) }}
                        >
                          {achievement.title}
                        </h3>
                      </div>
                    ...
                    <AnimatePresence>
                      {expandedAchievement === i && (
                        ...
                        >
                          <p className="text-[#666] text-sm md:text-base pb-6 md:pb-8" style={{ lineHeight: 1.8, ...(isMobile ? { fontSize: '12px', paddingBottom: '12px' } : {}) }}>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-[#21313c] text-xl md:text-2xl font-semibold mb-10" style={{ letterSpacing: '-0.02em', ...(isMobile ? { fontSize: '16px', marginBottom: '16px' } : {}) }}>
              Institutional Recognition
            </h3>

            {/* Bento grid — 2 tall left + 4 small right */}
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-5" style={isMobile ? { gridTemplateColumns: '1fr 1fr', gap: '8px' } : {}}>
              ...
              >
                ...
                <div className="relative z-10 p-8 md:p-10 flex flex-col justify-between h-full" style={isMobile ? { padding: '16px' } : {}}>
                  <div>
                    <div className="w-14 h-14 rounded-2xl bg-[#f0c14b]/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500" style={isMobile ? { width: '36px', height: '36px', marginBottom: '12px' } : {}}>
                    ...
                    <p className="text-white/60 text-sm md:text-base" style={{ lineHeight: 1.6, ...(isMobile ? { fontSize: '11px' } : {}) }}>
              ...
              {institutionalAwards.slice(1, 3).map((item, i) => (
                <motion.div
                  ...
                  style={{ backgroundColor: i === 0 ? '#f0c14b' : '#f6f7f0', border: i === 1 ? '1px solid #e5e5e5' : 'none', ...(isMobile ? { padding: '12px' } : {}) }}
                >
                  <div className="flex items-start gap-5" style={isMobile ? { gap: '10px' } : {}}>
                    <div
                      ...
                      style={{ backgroundColor: i === 0 ? 'rgba(33,49,60,0.15)' : `${item.accent}15`, ...(isMobile ? { width: '36px', height: '36px' } : {}) }}
                    >
                    ...
                    <div>
                      <h4
                        ...
                        style={{ color: i === 0 ? '#21313c' : '#21313c', letterSpacing: '-0.01em', ...(isMobile ? { fontSize: '12px' } : {}) }}
                      >
                        {item.award}
                      </h4>
              ...
              {institutionalAwards.slice(3).map((item, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className={`${i === 2 ? 'md:col-span-6' : 'md:col-span-3'} rounded-2xl p-6 md:p-7 relative overflow-hidden group cursor-default border border-[#e5e5e5] hover:border-transparent hover:shadow-lg transition-all duration-500`}
                  style={{ background: '#fff', ...(isMobile ? { padding: '12px', ...(i === 2 ? { gridColumn: 'span 2' } : {}) } : {}) }}
                >
                  {/* Hover accent line */}
                  <div
                  ...
                  <div
                    ...
                    style={{ backgroundColor: `${item.accent}15`, ...(isMobile ? { width: '32px', height: '32px', marginBottom: '8px' } : {}) }}
                  >
      ...
      <div id="events-and-festivals" className="w-full" style={{ backgroundColor: '#21313c' }}>
        <div className="mx-auto px-5 sm:px-8 md:px-[120px] py-20 md:py-28" style={{ maxWidth: '1440px', ...(isMobile ? { paddingTop: '30px', paddingBottom: '30px' } : {}) }}>
            ...
            {placementStats.map((stat, i) => (
              ...
              >
                <div className="flex items-baseline justify-center md:justify-start gap-1">
                  <span className="text-white text-3xl md:text-4xl lg:text-5xl font-semibold" style={{ letterSpacing: '-0.03em', ...(isMobile ? { fontSize: '22px' } : {}) }}>
                    {stat.number}
                  </span>
                  {stat.suffix && (
                ...
                <p className="text-white/50 text-sm mt-2" style={isMobile ? { fontSize: '11px' } : {}}>{stat.label}</p>
              </motion.div>
            ))}
          </motion.div>
          ...
          <motion.div
            ...
            style={isMobile ? { gap: '4px', marginBottom: '20px' } : {}}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: customEase }}
            viewport={{ once: true }}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-white text-xl md:text-2xl font-semibold mb-8" style={{ letterSpacing: '-0.02em', ...(isMobile ? { fontSize: '16px', marginBottom: '12px' } : {}) }}>
              Top Recruiters
            </h3>

            <div className="flex flex-wrap gap-2 mb-8" style={isMobile ? { gap: '4px', marginBottom: '12px' } : {}}>
                ...
                {topRecruiters[activeRecruiterCategory as keyof typeof topRecruiters].map((company, i) => (
                  <motion.span
                    ...
                    style={{
                      ...
                      ...(isMobile ? { padding: '6px 12px', fontSize: '11px', borderRadius: '8px' } : {}),
                    }}
                  >
                    {company}
                  </motion.span>
        ...
        <div className="mx-auto px-5 sm:px-8 md:px-[120px] py-20 md:py-32" style={{ maxWidth: '1440px', ...(isMobile ? { paddingTop: '40px', paddingBottom: '40px' } : {}) }}>
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20" style={isMobile ? { gap: '20px' } : {}}>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4" style={isMobile ? { gridTemplateColumns: 'repeat(2, 1fr)', gap: '8px' } : {}}>
            ...
            >
              ...
              <div className="bg-[#03463B] rounded-2xl p-8 md:p-10 text-white mb-6" style={isMobile ? { padding: '16px', marginBottom: '12px' } : {}}>
                ...
                <p className="text-white/70 text-sm md:text-base mb-6" style={{ lineHeight: 1.8, ...(isMobile ? { fontSize: '12px', marginBottom: '12px' } : {}) }}>
              ...
              <div className="bg-[#f6f7f0] rounded-2xl p-8 md:p-10" style={isMobile ? { padding: '16px' } : {}}>
                <h4 className="text-[#21313c] font-semibold text-lg mb-5" style={isMobile ? { fontSize: '14px', marginBottom: '10px' } : {}}>Hub Facilities</h4>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            ...
            <span
              ...
              style={{ fontSize: isMobile ? '3rem' : 'clamp(4rem, 10vw, 8rem)', lineHeight: 1, letterSpacing: '-0.04em' }}
            >
              500+
            </span>
            <p className="text-white/70 text-sm md:text-base uppercase tracking-widest" style={{ letterSpacing: '0.15em', ...(isMobile ? { fontSize: '11px' } : {}) }}>
      ...
      <div className="w-full" style={{ backgroundColor: '#f6f7f0' }}>
        <div className="mx-auto px-5 sm:px-8 md:px-[120px] py-20 md:py-28" style={{ maxWidth: '1440px', ...(isMobile ? { paddingTop: '30px', paddingBottom: '30px' } : {}) }}>
          ...
          >
            ...
            <p className="text-[#666] text-base md:text-lg max-w-3xl" style={{ lineHeight: 1.8, ...(isMobile ? { fontSize: '13px' } : {}) }}>
          ...
          <motion.div
            ...
            style={isMobile ? { gridTemplateColumns: 'repeat(2, 1fr)', gap: '8px' } : {}}
            variants={staggerContainer}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
              ...
              >
                ...
                <div className="p-7 md:p-8" style={isMobile ? { padding: '12px' } : {}}>
                  ...
                  <h3
                    ...
                    style={{ letterSpacing: '-0.02em', ...(isMobile ? { fontSize: '13px', marginBottom: '4px' } : {}) }}
                  >
                    {speaker.name}
                  </h3>
                  ...
                  <div className="pt-4 border-t border-[#e5e5e5]" style={isMobile ? { paddingTop: '8px' } : {}}>
                    <p className="text-[#666] text-sm" style={{ lineHeight: 1.6, ...(isMobile ? { fontSize: '11px' } : {}) }}>
                      {speaker.topic}
                    </p>
                  </div>
                </div>
          ...
          <motion.div
            ...
            style={isMobile ? { marginTop: '20px', gap: '4px' } : {}}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: customEase }}
            viewport={{ once: true }}
      ...
      {/* ═══════════════════════════════════════════════════════ */}
      <div className="w-full bg-white px-4 py-12 md:px-6 md:py-16 lg:px-10 lg:py-20" style={isMobile ? { padding: '16px 12px' } : {}}>
        <div
          ref={communityRef}
          className="relative overflow-hidden mx-auto h-[70vh] md:h-[80vh] lg:h-[90vh] rounded-2xl md:rounded-3xl lg:rounded-4xl"
          style={{ maxWidth: '1400px', ...(isMobile ? { height: '55vh' } : {}) }}
        >
          ...
          >
            <div className="text-center max-w-200 px-5 py-6 md:px-8 md:py-8 lg:px-10 lg:py-10">
              ...
              <motion.h2
                ...
                style={{ fontWeight: 600, fontSize: isMobile ? '1.3rem' : 'clamp(1.5rem, 5vw, 4rem)', lineHeight: 1.1, letterSpacing: '-0.03em' }}
              >
                More than a campus —{' '}
                <span style={{ fontFamily: "'Times New Roman', serif", fontStyle: 'italic', fontWeight: 400 }}>
                  it&apos;s a community
              ...
              <motion.p
                ...
                style={{ fontWeight: 400, lineHeight: 1.8, ...(isMobile ? { fontSize: '12px', marginBottom: '16px' } : {}) }}
              >
