...
const partners: Partner[] = [
  ...
  { name: 'Middlesex University', image: 'https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/mid.webp', type: 'university' },
  { name: "King's College London", image: 'https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/king.webp', type: 'university' },
  { name: 'National University of Singapore', shortName: 'NUS', image: 'https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/nus.webp', type: 'university' },

  // Industry with local logos
  { name: 'Confederation of Indian Industry', shortName: 'CII', image: 'https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/c11.webp', type: 'industry' },
  { name: 'FICCI', image: 'https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/ficci.webp', type: 'industry' },
  { name: 'Grant Thornton', image: 'https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/gt.webp', type: 'industry' },
  { name: 'ERA Foundation', shortName: 'ERA', image: 'https://jlu-website-media.s3.ap-south-1.amazonaws.com/website-content/era.webp', type: 'association' },
