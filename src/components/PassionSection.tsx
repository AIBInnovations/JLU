...
// Eager-import gsap + ScrollTrigger so the pin is registered synchronously
// when the section mounts. Dynamic import would race the user's first scroll
// and let content scroll past the unset pin.
